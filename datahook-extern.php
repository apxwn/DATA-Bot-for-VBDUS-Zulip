...
<body >
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <p class="lead">Hallo <?php echo $data['rufbname'] . ", die Suche in der <strong>Region " . $data['region']; ?>
...
foreach ($data['ergebnisse'] as $key => $ergebnis) {
  ...
  $output .= '<tbody><tr><th>Telefon</th><td><a href="tel:' . preg_replace('/[^0-9+]+/', '', $ergebnis['telefon']) . '">' . $ergebnis['telefon'] . '</td></tr>';
  $output .= '<tbody><tr><th>Mobil</th><td><a href="tel:' . preg_replace('/[^0-9+]+/', '', $ergebnis['mobil']) . '">' . $ergebnis['mobil'] . '</td></tr>';
